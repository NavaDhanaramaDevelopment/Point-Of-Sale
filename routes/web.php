...
Route::middleware(['auth', 'role:owner,admin,manager'])->group(function () {
    ...
    Route::prefix('customer-debts')->name('customer-debts.')->group(function () {
        ...
        Route::get('/customers-by-outlet', [CustomerDebtController::class, 'getCustomersByOutlet'])->name('customers-by-outlet');
        Route::get('/sales-by-outlet', [CustomerDebtController::class, 'getSalesByOutlet'])->name('sales-by-outlet');
    });
