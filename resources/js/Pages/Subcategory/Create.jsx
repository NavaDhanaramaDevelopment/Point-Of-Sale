...
export default function SubcategoryCreate({ categories, outlets }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        setErrors({});
        router.post(route('subcategory.store'), form, { onError: setErrors });
    };

    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-blue-800">Tambah Subkategori</h2>}>
