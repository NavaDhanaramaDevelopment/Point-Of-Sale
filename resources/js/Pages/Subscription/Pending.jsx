...
export default function Pending({ transaction, subscription }) {
            ...
            <div className="py-12">
                <div className="mx-auto max-w-3xl sm:px-6 lg:px-8">
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        {/* Pending Header */}
                        <div className="bg-gradient-to-r from-yellow-600 to-yellow-700 px-6 py-8 text-white text-center">
                            ...
                            <p className="text-yellow-100">Pembayaran Anda sedang diproses, mohon menunggu konfirmasi</p>
                        </div>
                        ...
                        <div className="p-6">
                            <div className="text-center mb-8">
                                ...
                                <p className="text-gray-600">
                                    Order ID: <span className="font-mono text-yellow-600">{transaction.order_id}</span>
                                </p>
                            </div>
                            ...
                            <div className="bg-yellow-50 rounded-lg p-6 border border-yellow-200 mb-6">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-sm text-yellow-600">/bulan</p>
                                    </div>
                                </div>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm border-t border-yellow-200 pt-4">
                                    <div>
                            ...
                            <div className="bg-blue-50 rounded-lg p-6 border border-blue-200 mb-6">
                                ...
                                <ul className="space-y-2 text-blue-700 text-sm">
                                    <li className="flex items-start">
                                        ...
                                        <span>Sistem akan memverifikasi pembayaran Anda secara otomatis</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="font-semibold mr-2">2.</span>
                                        <span>Proses verifikasi biasanya memakan waktu 5-15 menit</span>
                                    </li>
                                    <li className="flex items-start">
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <span>Fitur subscription akan aktif otomatis setelah payment berhasil</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 mb-6">
                                ...
                                <ul className="space-y-2 text-gray-700 text-sm">
                                    <li className="flex items-start">
                                        ...
                                        <span>Simpan Order ID ini untuk referensi: <strong>{transaction.order_id}</strong></span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="font-semibold mr-2">•</span>
                                        <span>Jangan melakukan pembayaran ulang untuk order yang sama</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="font-semibold mr-2">•</span>
                                        <span>Cek riwayat subscription secara berkala untuk update status</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="font-semibold mr-2">•</span>
                                        <span>Hubungi support jika payment pending lebih dari 1 jam</span>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div className="mt-8 text-center">
                        <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                            ...
                            <p className="text-gray-600 mb-4">
                                Tim support kami siap membantu Anda mengecek status pembayaran
                            </p>
